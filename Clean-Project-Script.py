...
def get_actor_components():
    ...
    if foliageBox == True:
        for actor in actors[3]:
            ...
            # print("myfoliage1: " + actor.get_name())
            ...
            # components = actor.get_components_by_class(unreal.Foliage_Type)  
...
def get_all_assets_of_type():
    ...
    for item in all_assets:
        ...
        if meshBox == True and isinstance(myItem, unreal.StaticMesh):
            ...
            # print("get called at: " + str(myItem))
...
def delete_assets():
    ...
    if bpBox == True:
        print("Deleting "+ str(len(assets_to_delete) + len(bps_to_delete)) + " assets: ")
        print("-------------------------------------")
        for i in bps_to_delete:
            unreal.EditorAssetLibrary.delete_loaded_asset(i)
    else:
        print("Deleting " + str(len(assets_to_delete)) + " assets: ")
        print("-------------------------------------")
...
delete_assets()
# select_actors(get_level_actors()[0])